...
import { deleteNewsAction } from "@/app/admin/(protected)/news/actions";
      ...
      {confirming && (
        ...
        >
          ...
          >
            ...
            <p id={`delete-description-${id}`} className="mt-2 text-sm text-muted-foreground">
              Delete “{title}”? This permanently removes the article and its tag
              links.
            </p>
            {error && (
